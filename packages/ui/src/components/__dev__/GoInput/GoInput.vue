<script lang="ts" setup>
  import type { GoInputProps, InputExpose } from '@/components/__dev__/GoInput/input.ts';
  import { getAutosize } from '@/components/__dev__/GoInput/input.ts';
  import { cleanValueByMask, getMaskParser } from '@/components/__dev__/GoInput/inputMasks.ts';
  import { parse } from '@/components/__dev__/GoInput/inputParsers.ts';
