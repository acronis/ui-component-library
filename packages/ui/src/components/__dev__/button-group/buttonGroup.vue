<script setup lang="ts">
  import type { ButtonGroupEvents, ButtonGroupProps, ButtonGroupSlots } from '@/components/__dev__/button-group/buttonGroup.ts';
  import { computed } from 'vue';
  import '@/components/__dev__/button-group/buttonGroup.css';
