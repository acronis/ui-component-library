<script lang="ts" setup>
  import type { SelectModel, SelectOptionValue, SelectProps } from '@/components/__dev__/GoSelect/select.ts';
  import { provideSelect } from '@/components/__dev__/GoSelect/select.ts';
