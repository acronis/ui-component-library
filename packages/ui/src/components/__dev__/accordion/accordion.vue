<script setup lang="ts">
  import type { AcvAccordionEvents, AcvAccordionProps, AcvAccordionSlots } from '@/components/__dev__/accordion/accordion.ts';
  import { ACCORDION_KEY } from '@/components/__dev__/accordion/accordion.ts';
  import { computed, getCurrentInstance, onMounted, provide, ref, watch } from 'vue';

  import '@/components/__dev__/accordion/accordion.css';
