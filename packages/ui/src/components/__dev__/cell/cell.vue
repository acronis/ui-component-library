<script setup lang="ts">
  import type { AcvCellProps } from '@/components/__dev__/cell/cell.ts';
  import type { ClassType } from '@/utils/props.ts';
  import type { ComputedRef, CSSProperties } from 'vue';
  import { isPositionSet, parsePosition, queryBreakPointOptions } from '@/components/__dev__/cell/utils.ts';
