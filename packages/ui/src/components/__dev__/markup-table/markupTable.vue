<script setup lang="ts">
  import type { AcvMarkupTableColumn, AcvMarkupTableProps } from '@/components/__dev__/markup-table/markupTable.ts';
  import { useGridColumns } from '@/components/__dev__/markup-table/composables/useGridColumns.ts';
  import { useResizingColumns } from '@/components/__dev__/markup-table/composables/useResizingColumns.ts';
  import { computed, toRefs } from 'vue';
  import '@/components/__dev__/markup-table/markupTable.css';
