<script setup lang="ts">
  import type { AcvListEvents, AcvListProps, AcvListSlots } from '@/components/__dev__/list/list.ts';
  import { LIST_KEY } from '@/components/__dev__/list/list.ts';
  import AcvListItem from '@/components/__dev__/list-item/listItem.vue';
  ...
  import '@/components/__dev__/list/list.css';
