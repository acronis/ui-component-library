<script setup lang="ts">
  import type { AcvGridProps } from '@/components/__dev__/grid/grid.ts';
  import type { CSSProperties } from 'vue';
  import { GRID_KEY } from '@/components/__dev__/grid/grid.ts';
  import { parseAutoLayout, parseSizeLayout } from '@/components/__dev__/grid/utils.ts';
  import { computed, provide, reactive, toRef } from 'vue';
  import '@/components/__dev__/grid/grid.css';
