<script setup lang="ts">
  import type { AcvRibbonEvents, AcvRibbonLink, AcvRibbonProps, AcvRibbonSlots } from '@/components/__dev__/ribbon/ribbon.ts';
  import Alert from '@/components/alert/alert.vue';
  import Button from '@/components/button/button.vue';
  import AcvDivider from '@/components/divider/divider.vue';
  import AcvLink from '@/components/link/link.vue';
  import { computed, ref } from 'vue';
  import '@/components/__dev__/ribbon/ribbon.css';
