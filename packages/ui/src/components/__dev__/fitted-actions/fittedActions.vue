<script setup lang="ts">
  import type { AcvFittedAction, AcvFittedActionsProps, AcvFittedItem } from '@/components/__dev__/fitted-actions/fittedActions.ts';
  import type { Ref } from 'vue';
  import AcvDropdown from '@/components/__dev__/dropdown/dropdown.vue';
  import AcvDropdownMenu from '@/components/__dev__/dropdown/dropdownMenu.vue';
  import useFittedActions from '@/components/__dev__/fitted-actions/useFittedActions.ts';
  import ListItem from '@/components/__dev__/list-item/listItem.vue';
  import AcvButton from '@/components/button/button.vue';
  import { ref, toRefs } from 'vue';

  import '@/components/__dev__/fitted-actions/fittedActions.css';
