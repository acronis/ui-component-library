<script setup lang="ts">
  import type { AcvRowInjection, AcvRowProps, AcvRowSlots } from '@/components/__dev__/row/row.ts';
  import { ROW_KEY } from '@/components/__dev__/row/row.ts';
  import { computed, provide, reactive, toRef } from 'vue';
  import '@/components/__dev__/row/row.css';
