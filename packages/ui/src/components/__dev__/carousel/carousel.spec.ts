import type { AcvCarouselProps } from '@/components/__dev__/carousel/carousel.ts';
import Carousel from '@/components/__dev__/carousel/carousel.vue';
import AcvCarouselItem from '@/components/__dev__/carousel-item/carouselItem.vue';
