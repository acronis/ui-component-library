<script setup lang="ts">
  import type { AcvListInjection } from '@/components/__dev__/list/list.ts';
  import type {
    AcvListItemEvents,
    AcvListItemProps,
    AcvListItemSlots
  } from '@/components/__dev__/list-item/listItem.ts';
  import { LIST_KEY } from '@/components/__dev__/list/list.ts';
  ...
  import AcvIcon from '@/components/__dev__/icon/icon.vue';
  import '@/components/__dev__/list-item/listItem.css';
