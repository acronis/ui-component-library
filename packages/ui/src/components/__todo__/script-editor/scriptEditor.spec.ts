import type { AcvScriptEditorProps } from '@/components/__todo__/script-editor/scriptEditor.ts';
import ScriptEditor from '@/components/__todo__/script-editor/scriptEditor.vue';
