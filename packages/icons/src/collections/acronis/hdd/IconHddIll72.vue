<template>
  ...
  >
    <path
      fill="#B1B7C2"
      d="M11 8a4 4 0 0 1 4-4h42a4 4 0 0 1 4 4v56a4 4 0 0 1-4 4H15a4 4 0 0 1-4-4V8Z"
    />
    <path
      fill="#8C93A1"
      d="M11 62v2a4 4 0 0 0 4 4h42a4 4 0 0 0 4-4v-2a4 4 0 0 1-4 4H15a4 4 0 0 1-4-4Z"
    />
    <path
      fill="#798190"
    ...
    <path
      fill="url(#d)"
      d="M12 8.5A3.5 3.5 0 0 1 15.5 5h41A3.5 3.5 0 0 1 60 8.5v53a3.5 3.5 0 0 1-3.5 3.5h-41a3.5 3.5 0 0 1-3.5-3.5v-53Z"
    />
    <path
      fill="#fff"
      d="M15.5 5A3.5 3.5 0 0 0 12 8.5v1A3.5 3.5 0 0 1 15.5 6h41A3.5 3.5 0 0 1 60 9.5v-1A3.5 3.5 0 0 0 56.5 5h-41Z"
      opacity=".6"
    />
    <path
      fill="url(#e)"
    ...
    <path
      fill="#243143"
      fill-opacity=".9"
      d="M57 61a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"
      opacity=".8"
    />
    <path
      fill="#CED3D9"
    ...
    <path
      fill="#243143"
      d="M23.955 38.935c-.305-.384-.955-.175-.955.315v3.876a4 4 0 0 0 1.44 3.073l3.085 2.571c2.57 2.142 2.125 7.23 6.113 7.23h7.037a2.836 2.836 0 0 0 2.781-2.28c.35-1.748 1.013-2.455 2.558-3.227 1.664-.833 2.367-1.836 1.587-3.525l-1.852-5.011a.514.514 0 0 0-.77-.194C42.178 43.8 39.73 45 36 45c-5.224 0-9.089-2.356-12.045-6.064Z"
      opacity=".15"
    />
    <defs>
      <linearGradient
