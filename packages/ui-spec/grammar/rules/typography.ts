...
export const typographyRules = [
  {
    ...
    rationale:
      'An off-scale size breaks the typographic hierarchy shared across screens.',
    checklist: 'Y1',
  ...
  },
  {
    ...
    rationale:
      'Inconsistent line-height changes vertical rhythm between text blocks.',
    checklist: 'Y2',
  ...
  },
  {
    ...
    rationale:
      'Stray weights read as off-brand and complicate the font payload.',
    checklist: 'Y3',
  ...
  },
  {
    ...
    rationale:
      'Mixed casing (Title Case vs sentence case) across buttons/headers looks unpolished.',
    checklist: 'Y4',
