...
| page-header-double-banner-landmark             | PageHeader role="banner" creates a second banner landmark alongside the app header                 | page-header (ui-react)         | — (new-rule needed)                      | should | open     | landmark-uniqueness rule (one banner/screen) + drop role="banner" from PageHeader; surfaced by the demo screen-audit fixtures |
