...
| page-header-double-banner-landmark             | PageHeader role="banner" creates a second banner landmark alongside the app header                 | page-header (ui-react)         | accessibility/landmark-uniqueness (I6)   | should | resolved | new rule I6 + detector `screen/landmark-uniqueness` (one banner/main/contentinfo per screen); dropping PageHeader role="banner" is a follow-up |
