 ...
 * @example
 * ```typescript
 * import { applyTheme } from '@spec-lab/shadcn-uikit/utils/theme-switcher'
 *
 ...
 * @example
 * ```typescript
 * import { applyColorMode } from '@spec-lab/shadcn-uikit'
 *
 * applyColorMode('dark')
 ...
 * @example
 * ```typescript
 * import { initializeThemeSystem } from '@spec-lab/shadcn-uikit'
 *
