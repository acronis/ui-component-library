...
const componentsList = [
  ...
  { text: 'Checkbox Button', link: '/components/checkbox-button/checkboxButton.md' },
  { text: 'Checkbox Group', link: '/components/checkbox-group/checkboxGroup.md' },
  { text: 'Checkbox', link: '/components/checkbox/checkbox.md', readyForReview: true },
  { text: 'Chip', link: '/components/chip/chip.md' },
  ...
  { text: 'Icon Button', link: '/components/icon-button/iconButton.md' },
  ...
  { text: 'Markdown Editor', link: '/components/markdown-editor/markdownEditor.md' },
  ...
  { text: 'Radio Button', link: '/components/radio-button/radioButton.md' },
  { text: 'Radio Group', link: '/components/radio-group/radioGroup.md' },
  ...
  { text: 'Switch', link: '/components/switch/switch.md' },
