...
const componentsList = [
  ...
  { text: 'Button', link: '/components/button/button.doc.md', readyForReview: true },
  ...
  { text: 'Checkbox', link: '/components/checkbox/checkbox.doc.md', readyForReview: true },
  ...
  { text: 'Divider', link: '/components/divider/divider.doc.md', readyForReview: true },
  ...
  { text: 'Footer', link: '/components/footer/footer.doc.md', readyForReview: true },
  ...
  { text: 'Radio', link: '/components/radio/radio.doc.md', readyForReview: true },
  ...
  { text: 'Spinner', link: '/components/spinner/spinner.doc.md', readyForReview: true },
  ...
  { text: 'Tooltip', link: '/components/tooltip/tooltip.doc.md', readyForReview: true },
