...
/** Upload Component */
export declare class ElUpload extends UIKitComponent {
  ...
  /** Upload form width in pixels */
  width: number | string

  /** Upload form height in pixels */
  height: number | string

  /** Upload button text */
  buttonText: string

  /** Whether default slot is visible during drag over */
