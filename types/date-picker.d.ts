...
export type DatePickerType = 'year' | 'month' | 'date' | 'daterange' | 'daterangepredef' | 'multi'
...
export interface DatePickerOptions {
  ...
  /** A callback that triggers when the seleted date is changed. Only for daterange. */
  onPick?: PickEventHandler
}

/** DatePicker Component */
export declare class ElDatePicker extends UIKitComponent {
