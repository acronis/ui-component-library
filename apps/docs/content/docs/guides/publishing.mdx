...
- `@spec-lab/ui-react` — the next-generation React component library
  (primary)
- `@spec-lab/shadcn-uikit` — the legacy library (`ui-legacy`)
...
import { Button, InputText, Switch } from '@spec-lab/ui-react';
