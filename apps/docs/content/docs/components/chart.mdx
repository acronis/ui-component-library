...
`ChartLegendContent` give the tooltip and legend the UI Components library look. You compose the
...
> `recharts` resolves as a dependency of `@constructor-lab/ui-react`; import the
