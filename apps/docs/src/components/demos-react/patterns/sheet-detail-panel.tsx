...
import { SheetDetailPanelDemo as SharedSheetDetailPanelDemo } from '@constructor-lab/ui-kit-demos/patterns';
...
// Passes the shadow mount so the sheet overlay portals into the shadow root and
// inherits ui-react's styles. See apps/docs/AGENTS.md.
export function SheetDetailPanelDemo() {
  const mount = useShadowMount();
  return <SharedSheetDetailPanelDemo portalContainer={mount} />;
}
