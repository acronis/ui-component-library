...
import { IntelligencePanelDemo as SharedIntelligencePanelDemo } from '@constructor-lab/ui-kit-demos/patterns';
...
// Passes the shadow mount so the drawer overlay portals into the shadow root and
// inherits ui-react's styles. See apps/docs/AGENTS.md.
export function IntelligencePanelDemo() {
  const mount = useShadowMount();
  return <SharedIntelligencePanelDemo portalContainer={mount} />;
}
