...
```bash
bash .Codex/skills/component-readiness/scripts/audit.sh all          # or a single component
bash .Codex/skills/component-readiness/scripts/audit.sh InputTextArea
```
...
node .Codex/skills/component-readiness/scripts/parity-values.mjs <Component> figma-vars.json [--theme light|dark] [--brand acronis]
```
...
node .Codex/skills/component-readiness/scripts/parity-image.mjs figma.png \
