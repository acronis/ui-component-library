...
```bash
node .Codex/skills/token-gap-check/scripts/check.mjs /tmp/<name>-vars.json
```
...
node .Codex/skills/component-readiness/scripts/parity-image.mjs /tmp/<name>-figma.png \
